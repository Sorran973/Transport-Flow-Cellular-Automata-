 ...
 */
public class OneLaneRoad implements Road {

    private static final int[] y = {0, 2};
    private TrafficLight trafficLight1;
    private TrafficLight trafficLight2;

    public OneLaneRoad(Grid grid) {
        ...
        trafficLight1 = new TrafficLight(40, 1, grid);
        trafficLight2 = new TrafficLight(70, 1, grid);
    }
